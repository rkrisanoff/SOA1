...
@Data
public class StudyGroupValidated {
    @NotNull
    ...
    @Max(value = 9223372036854775807L, message = "studentsCount must be less than 2147483647")
    @NotNull(message = "studentsCount must be not null")
    private String studentsCount; //Значение поля должно быть больше 0
